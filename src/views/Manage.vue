...
<template>
  ...
  <div style="height: 60px; background-color: cornflowerblue; display: flex; align-items: center">
    <div style="padding-left:30px; width: 200px; display: flex; align-items: center; font-size: 20px; color: white">
      图书后台管理系统
    </div>
    <div style="flex: 1"></div>
    <div style="width: 150px; display: flex;align-items: center; padding-right: 10px">
      <img src="@/assets/touxiang.jpg" alt="头像" style="width: 40px; height: 40px;">
      <span style="color: white; margin-left: 5px;">孙悟空</span>
    </div>
  </div>
  <!-- 头部结束-->
